...
class BeerControllerIT {
    ...
    void testNoAuth() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(get(BeerController.BEER_PATH)
                        .with(httpBasic("WRONG_USER", "WRONG_PWD")))
                .andExpect(status().isUnauthorized())
                .andDo(print())
                .andReturn();

        String errorMessage = Objects.requireNonNull(mvcResult.getResponse().getErrorMessage());

        System.out.printf("### the errorMsg: %s%n ###", errorMessage);
    }
