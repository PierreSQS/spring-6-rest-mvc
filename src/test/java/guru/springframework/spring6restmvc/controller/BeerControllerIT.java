...
import static guru.springframework.spring6restmvc.controller.CustomerControllerTest.PWD;
import static guru.springframework.spring6restmvc.controller.CustomerControllerTest.USERNAME;
...
class BeerControllerIT {
    ...
    @Disabled("Just for demo purpose") 
    @Test
    ...
    @Test
    void tesNoAut() throws Exception {
        mockMvc.perform(get(BeerController.BEER_PATH)
                        .queryParam("beerName", "IPA")
                        .queryParam("beerStyle", BeerStyle.IPA.name())
                        .queryParam("pageSize", "800"))
    ...
    void testDeleteByIDNotFound() {
        ...
        assertThrows(NotFoundException.class, () -> beerController.deleteById(beerUUId));
    }
    ...
    void testUpdateNotFound() {
        ...
        assertThrows(NotFoundException.class, () -> beerController.updateById(beerUUId, beerDTO));
    }
    ...
    void testBeerIdNotFound() {
        UUID beerUUId = UUID.randomUUID();
        assertThrows(NotFoundException.class, () -> beerController.getBeerById(beerUUId));
    }
